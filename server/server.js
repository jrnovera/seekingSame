...
try {
  ...
  console.warn('dotenv not installed; ensure environment variables are provided by your runtime');
}
...
try {
  ...
  if (!stripeSecretKey) {
    console.warn('STRIPE_SECRET_KEY is not set. Stripe will not be initialized.');
  } else {
